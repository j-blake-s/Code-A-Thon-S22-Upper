...
#   python3 ./solutions/sol.py < input/input$i.txt > output/output$i.txt
    echo $i | python3 input_gen/make_0s_and_1s.py | python3 input_gen/make_connected_letters_message.py > input/input$i.txt

    # python3 ./solutions/sol.py < input/input$i.txt
